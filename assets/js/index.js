...
// import semua komponen dan function
...
/**
 * tangkap semua genre, cth: [{"id": "123", "name": "Action"}] kemudian ubah formatnya menjadi { 123: "Action" }
*/
const genreList = {
  /**
   * buat string genre dari genre_id cth: [23, 43] -> "Action, Romance"
  */
...
const heroBanner = function({ results: movieList }) {
  ...
  for(const [index, movie] of movieList.entries()) {
    ...
    controlItem.innerHTML = `
      <img src="${imageBaseURL}w154${poster_path}" class="img-cover" alt="Slide to ${title}" loading="lazy" draggable="false">
    `;
  ...
  /**
   * ambil data dari home page sections (top rated, upcoming, trending)
  */
...
const createMovieList = function({results: movieList}, title) {
  ...
  for(const movie of movieList) {
    const movieCard = createMovieCard(movie) // mengambil dari movie_card.js
