...
const movie_id = window.localStorage.getItem("movie_id");
...
// return hanya trailer dan teaser sebagai array
...
fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movie_id}?api_key=${api_key}&append_to_response=casts,videos,images,releases`, function(movie) {
  ...
  fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movie_id}/recommendations?api_key=${api_key}&page=1`, addSugestedMovies);
});

const addSugestedMovies = function({results: movieList}) {
